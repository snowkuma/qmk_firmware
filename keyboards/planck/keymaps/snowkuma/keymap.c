...
[_NUMBER] = LAYOUT_planck_grid(
    ...
    KC_HASH, S(KC_C), S(KC_B), A_SFT,   KC_COLN, _______, _______, KC_DOT,  KC_4,    KC_5,    KC_6,    KC_SLSH,
    EURO,    KC_X,    GBP,     KC_EQL,  KC_PLUS, _______, _______, KC_COMM, KC_1,    KC_2,    KC_3,    KC_BSLS,
    _______, _______, _______, ___f___, _______, KC_MINS, _______, KC_0,    KC_ENT,  _______, _______, _______
),
...
[_THUMB] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______,  TXT_MIN, _______, _______, _______, _______, _______, _______
),
